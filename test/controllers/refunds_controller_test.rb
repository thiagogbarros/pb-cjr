...
class RefundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create refund" do
    assert_difference('Refund.count') do
      post refunds_url, params: { refund: { image: @refund.image, title: @refund.title, value: @refund.value } }
    end
  ...
  test "should update refund" do
    patch refund_url(@refund), params: { refund: { image: @refund.image, title: @refund.title, value: @refund.value } }
